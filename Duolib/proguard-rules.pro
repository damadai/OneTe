...
-keep class org.webrtc.** {*;}## 226版相机需要

# 本库混淆
-keep class com.cloud.duolib.CloudBuilder {*;}## 初始化入口
-keep class com.cloud.duolib.bean.** {*;}## 数据结构
-keep class com.cloud.duolib.http.** {*;}## 数据请求
-keep class com.lzf.easyfloat.** {*;}

#webview js
-keepattributes *Annotation*
-keepattributes *JavascriptInterface*
-keepclassmembers class com.cloud.duolib.ui.WebViewActivity{
   public *;
}
