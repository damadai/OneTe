...
public class CornerLabelView extends View {
    ...
    private float myTextSize = 16;
    private float mySlantedHeight = 45;//倾斜高度
    ...
    private void init(AttributeSet attrs) {
        //加载默认属性
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.CornerLabelView);
        myBackgroundColor = array.getColor(R.styleable.CornerLabelView_myBackgroundColor, myBackgroundColor);
        myTextSize = array.getDimension(R.styleable.CornerLabelView_myTextSize, myTextSize);
        myTextColor = array.getColor(R.styleable.CornerLabelView_myTextColor, myTextColor);
        PADDING_TOP = array.getDimension(R.styleable.CornerLabelView_myPaddingTop, PADDING_TOP);
        mySlantedHeight = array.getDimension(R.styleable.CornerLabelView_mySlantedHeight, mySlantedHeight);

        if (array.hasValue(R.styleable.CornerLabelView_tagModel))//判断用户是否设置该方法
            TAG_Mode = array.getInt(R.styleable.CornerLabelView_tagModel, TAG_LEFT);
        if (array.hasValue(R.styleable.CornerLabelView_myText))
            myText = array.getString(R.styleable.CornerLabelView_myText);
    ...
    public CornerLabelView setText(int res) {
    ...
    public CornerLabelView setTextSize(int size) {
    ...
    //背景颜色
    public CornerLabelView setBackground(int color) {
    ...
    public CornerLabelView setMode(int mode) {
    ...
    public CornerLabelView setSlantedHeight(int length) {
        mySlantedHeight = length;
        postInvalidate();
        return this;
    }

    public CornerLabelView setPadding(int padding) {
        PADDING_TOP = padding;
        postInvalidate();
        return this;
    }
